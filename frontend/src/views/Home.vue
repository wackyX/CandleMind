<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">CANDLEMIND</div>
      <div class="nav-links">
        <LanguageSwitcher />
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="/candlemind-logo.svg" alt="烛机 CandleMind Logo" class="hero-logo" />
          </div>
...
.stock-prophecy-btn:hover {
  background: var(--orange);
  border-color: var(--orange);
}

.stock-prophecy-btn span {
  margin-left: 10px;
}
